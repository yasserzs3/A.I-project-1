...
def draw_window(win, birds, pipes, base, score, gen,popualtion, pipe_ind):
    ...
    win.blit(txt, (10, 10))
    txt_2 = STAT_FONT.render("Alive: " + str(popualtion), 1, (255, 255, 255))
    win.blit(txt_2, (10, 50))
    base.draw(win)
    for bird in birds:
        try:
...
def main(genomes, config):
    ...
    while run:
        ...
        base.move()
        draw_window(win, birds, pipes, base, score, GEN, len(birds), pipe_index)
